...
Route::get('dashboard/solicitudes', [DashboardController::class, 'getEstadisticasSolicitudes']);
Route::get('dashboard/solicitudes-por-sede', [DashboardController::class, 'getSolicitudesPorSede']);
